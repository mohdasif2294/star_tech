  ...
  onGenderClick: function() {
	...
	render: function () {
		return (
			<div style={
                {
                 border: '1px solid #a0a1a2e3'
                }
              }>
        <div className="container-fluid">
        <span className="col-xs-12" style={{fontFamily:"verdana"}}>Gender</span>
        ...
        <hr></hr>
        <div className="container-fluid">
        <span className="col-xs-12" style={{fontFamily:"verdana"}}>Category</span>
        <hr></hr>
        <Multiselect
        ...
        <hr></hr>
        <div className="container-fluid">
        <span className="col-xs-12" style={{fontFamily:"verdana"}}>Brands</span>
        <hr></hr>
				<Multiselect
        ...
        <hr></hr>
        <div className="container-fluid">
        <span className="col-xs-12" style={{fontFamily:"verdana"}}>Size</span>
        ...
        <hr></hr>
        <div className="container-fluid">
        <span className="col-xs-12" style={{fontFamily:"verdana"}}>Color</span>
